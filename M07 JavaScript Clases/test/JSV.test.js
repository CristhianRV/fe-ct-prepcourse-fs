...
describe("JAVASCRIPT V", function () {
  describe("EJERCICIO 01", function () {
    describe("crearUsuario()", function () {
      xit('Debe retornar una clase con las propiedades "usuario", "nombre", "email" y "password" definidas', function () {
      ...
      xit("Debe retornar una clase con un método saludar que retorne el string correspondiente", function () {
        const Usuario = crearUsuario();
        const user = new Usuario(
          "jssamuel",
          "Samuel",
    ...
    describe("agregarMetodoPrototype(Constructor)", function () {
      xit('Debe agregar un método "saludar" al contructor de Usuario', function () {
        function Test() {
          this.test = true;
        }
    ...
    describe("agregarStringInvertida(StringPrototype)", function () {
      xit('Debe agregar un método al objeto global "String", invirtiendo la cadena de texto', function () {
        agregarStringInvertida();
        const str = "Hello";
