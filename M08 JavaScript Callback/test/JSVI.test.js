...
describe("JAVASCRIPT VI", function () {
  describe("mayuscula(nombre)", function () {
    xit("Debe retornar el mismo nombre, pero con la primera letra en mayúscula", function () {
  ...
  describe("invocarCallback(cb)", function () {
    xit("Debe invocar/ejecutar el callback", function () {
      const cb = jest.fn();
      invocarCallback(cb);
  ...
  describe("operacionMatematica(n1, n2, cb)", function () {
    xit("Debe retornar el resultado del callback habiéndole pasado como arguemnto los números recibidos.", function () {
      const cb = jest.fn();
  ...
  describe("map(array, cb)", function () {
    xit("Debe retornar un arreglo con el resultado de todos los elementos del arreglo pasados por el callback", function () {
  ...
  describe("filter(arrayOfStrings)", function () {
    xit('Debe retornar un arreglo con todos los elementos que comiencen con la letra "a"', function () {
      var array = [
        "abajo",
        "pera",
        "escalera",
